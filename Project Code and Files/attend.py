...
class ATT:
    def __init__(self,root):
        ...
        Right_frame.place(x=10,y=10,width=1420,height=685)

        fl3=Label(Right_frame,text="Student Attendance Database",font=("times new roman",35,"bold"),bg="navy",fg="white")
        fl3.place(x=10,y=10,width=1400,height=55)

        # Table
        T_frame=Frame(Right_frame,bd=2,bg="white",relief=RIDGE)
        T_frame.place(x=10,y=80,width=1400,height=600)
        ...
        self.st.bind("<ButtonRelease>",self.get_cursor)
         ...
         # #button
        B_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,font=("times new roman",12,"bold"))
        B_frame.place(x=500,y=705,width=560,height=50)

        b=Button(B_frame,text="Return Home",width=17,command=self.des,font=("times new roman",12,"bold"),bg="blue",fg="white")
        b.grid(row=1,column=2,padx=10,pady=2,sticky=W)
        ...
        b4 = Button(B_frame, text="Clear all", width=17, font=("times new roman", 12, "bold"), bg="blue", fg="white", command=self.clear_all)        
    ...
    #             messagebox.showinfo("Data Export","Your data is exported successfully",parent=self.root)
    ...
    def clear_all(self):
        for row in self.st.get_children():
            self.st.delete(row)
